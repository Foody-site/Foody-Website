...
const PlaceSearch = ({ selectedRegion, setSelectedRegion, selectedCity, setSelectedCity }) => {
    const regionOptions = [
    ...
    const currentCityOptions = cityOptionsMap[selectedRegion] || [{ value: "", label: "قم بإختيار المدينة" }];
