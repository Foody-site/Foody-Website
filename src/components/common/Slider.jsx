                ...
                <div className="flex flex-col items-center gap-4">
                    <button
                        ...
                        className={`btn btn-circle border-2 rounded-full p-2 text-primary-1 border-primary-1 transition-all duration-300 
                            ${page === 0 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-primary-1 hover:text-white'}`}
                    >
                        <FaChevronUp />
                    </button>
                    ...
                    <button
                        ...
                        className={`btn btn-circle border-2 rounded-full p-2 text-primary-1 border-primary-1 transition-all duration-300 
                            ${page === totalPages - 1 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-primary-1 hover:text-white'}`}
                    >
                        <FaChevronDown />
                    </button>
                </div>
